...
see [vignette](./inst/doc/related_ast_functions.html) for a comparison among these functions.
...
* `nest_expr(expr, target, count)` this recursively calls calls walk_ast()
